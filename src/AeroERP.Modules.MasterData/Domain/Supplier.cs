...
public sealed class Supplier : Entity, IAggregateRoot
{
    ...
    public Supplier(string code, string name, string contactName, string phone, bool isEnabled, Guid? organizationId, string organizationName, string currencyCode, string taxpayerId, string invoiceTitle)
    {
        Code = code;
        Name = name;
